...
void Display::update(){
    ...
    //     }
    // }
    // CLAY(CLAY_ID("OuterContainer"), { .layout = { .sizing = { .width = CLAY_SIZING_GROW(0), .height = CLAY_SIZING_GROW(0) }, .padding = { 16, 16, 16, 16 }, .childGap = 16 }, .backgroundColor = Clay_Color({200, 200, 200, 0}) }) {
    //     CLAY(CLAY_ID("SideBar"), { .layout = { .sizing = { .width = CLAY_SIZING_FIXED(300), .height = CLAY_SIZING_GROW(0) }, .padding = {16, 16, 16, 16 }, .childGap = 16, .layoutDirection = CLAY_TOP_TO_BOTTOM }, .backgroundColor = {150, 150, 255, 255} }) {
    ...
    //             CLAY_TEXT(profileText, CLAY_TEXT_CONFIG({ .textColor = Clay_Color({0, 0, 0, 255}), .fontSize = 24, .textAlignment = CLAY_TEXT_ALIGN_RIGHT }));
    //         }
    ...
    //     CLAY(CLAY_ID("RightPanel"), { .layout = { .sizing = { .width = CLAY_SIZING_GROW(0), .height = CLAY_SIZING_GROW(0) }, .childGap = 16, .layoutDirection = CLAY_TOP_TO_BOTTOM }}) {
    //         CLAY_AUTO_ID({ .layout = { .sizing = { .width = CLAY_SIZING_GROW(0) }, .padding = {8, 8, 8, 8 }, .childGap = 8, .childAlignment = { .x = CLAY_ALIGN_X_RIGHT } }, .backgroundColor =  {180, 180, 180, 255} }) {
    ...
    //         }
    //         CLAY(CLAY_ID("MainContent"), {
    //             .layout = { .sizing = { .width = CLAY_SIZING_GROW(0) }, .padding = {16, 16, 16, 16}, .childGap = 16, .layoutDirection = CLAY_TOP_TO_BOTTOM },
    ...
    //                  .floating = { .offset = {0, 0}, .zIndex = 1, .attachPoints = { CLAY_ATTACH_POINT_CENTER_TOP, CLAY_ATTACH_POINT_CENTER_TOP }, .attachTo = CLAY_ATTACH_TO_PARENT },
    //                  .border = { .color = Clay_Color({80, 80, 80, 255}), .width = CLAY_BORDER_OUTSIDE(2) },
    //              }) {
    ...
    //                  CLAY_TEXT_CONFIG({ .textColor = Clay_Color({0,0,0,255}), .fontId = 0, .fontSize = 24 }));

    //              CLAY(CLAY_ID("Photos2"), { .layout = { .padding = { 16, 16, 16, 16 }, .childGap = 16 }, .backgroundColor = Clay_Color({180, 180, 220, static_cast<float>(Clay_Hovered() ? 120 : 255)}) }) {
    ...
    //              CLAY(CLAY_ID("Photos"), { .layout = { .sizing = { .width = CLAY_SIZING_GROW(0) }, .padding = {16, 16, 16, 16}, .childGap = 16, .childAlignment = { .x = CLAY_ALIGN_X_CENTER, .y = CLAY_ALIGN_Y_CENTER } }, .backgroundColor = {180, 180, 220, 255} }) {
    //                  CLAY(CLAY_ID("Picture2"), { .layout = { .sizing = { .width = CLAY_SIZING_FIXED(120) }}, .aspectRatio = {0.5f}}) {}
    //                  CLAY(CLAY_ID("Picture1"), { .layout = { .padding = {8, 8, 8, 8}, .childAlignment = { .x = CLAY_ALIGN_X_CENTER }, .layoutDirection = CLAY_TOP_TO_BOTTOM }, .backgroundColor = {170, 170, 220, 255} }) {
    ...
    //                  }
    //                  CLAY(CLAY_ID("Picture3"), { .layout = { .sizing = { .width = CLAY_SIZING_FIXED(120) }}, .aspectRatio = {2.0f} }) {}
    //              }
    ...
    //     CLAY(CLAY_ID("Blob4Floating2"), { .floating = { .parentId = Clay_GetElementId(CLAY_STRING("SidebarBlob4")).id, .zIndex = 1, .attachTo = CLAY_ATTACH_TO_ELEMENT_WITH_ID } }) {
    ...
    //             CLAY(CLAY_ID("FloatingContainer2"), { .layout = { .sizing = { .height = CLAY_SIZING_GROW() }}, .floating = { .zIndex = 1, .attachTo = CLAY_ATTACH_TO_PARENT } }) {
    ...
    CLAY(CLAY_ID("OuterContainer"), { 
        ...
        CLAY(CLAY_ID("SideBar"), { 
            ...
            button(CLAY_STRING("BWEH"));
            button(CLAY_STRING("BWEH1"));
            button(CLAY_STRING("BWEH2"));
            button(CLAY_STRING("BWEH3"));
        }
